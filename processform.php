    ...
    <header>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                <a href='deletereport.php?Inspection_Date=" . $row['Inspection_Date'] ."&Farm_id=" . urlencode($row['Farm_id']) . "' onclick='return confirm(\"Are you sure you want to delete this farm?\");'>Delete</a>
              </td>";
                    echo "</tr>";
                }
            } else {
